CREATE TABLE IF NOT EXISTS `student_mat` (
    ...
    `age` INT,
    `address` VARCHAR(1) CHARACTER SET utf8,
    `famsize` VARCHAR(3) CHARACTER SET utf8,
    `Pstatus` VARCHAR(1) CHARACTER SET utf8,
    `Medu` INT,
    `Fedu` INT,
    `Mjob` VARCHAR(8) CHARACTER SET utf8,
    `Fjob` VARCHAR(8) CHARACTER SET utf8,
    `reason` VARCHAR(10) CHARACTER SET utf8,
    `guardian` VARCHAR(6) CHARACTER SET utf8,
    `traveltime` INT,
    `studytime` INT,
    `failures` INT,
    `schoolsup` VARCHAR(3) CHARACTER SET utf8,
    `famsup` VARCHAR(3) CHARACTER SET utf8,
    `paid` VARCHAR(3) CHARACTER SET utf8,
    `activities` VARCHAR(3) CHARACTER SET utf8,
    `nursery` VARCHAR(3) CHARACTER SET utf8,
    `higher` VARCHAR(3) CHARACTER SET utf8,
    `internet` VARCHAR(3) CHARACTER SET utf8,
    `romantic` VARCHAR(3) CHARACTER SET utf8,
    `famrel` INT,
    `freetime` INT,
    `goout` INT,
    `Dalc` INT,
